...
public class SearchServiceImpl implements ISearchService {
    ...
    public boolean insert(Goods goods) {
        ...
        solrInputFields.addField("save",goods.getSave());
        solrInputFields.addField("subject",goods.getSubject());
        solrInputFields.addField("price",goods.getPrice().doubleValue());
        solrInputFields.addField("info",goods.getInfo());

        //处理封面
        solrInputFields.addField("images",goods.getFengmian());
    ...
    public List<Goods> query(String keyword, Page page) {
        ...
        //limit ?,?
        //
/*        solrQuery.setStart(page.getOffset());
...
//        solrQuery.setHighlightSnippets(2);//高亮折叠的次数 //..javaxxxxxxxxxxx..xxxxxJavaxxxx.
        ...
        try {
            ...
            //获得分页的总条数
           int count = (int) documents.getNumFound();
